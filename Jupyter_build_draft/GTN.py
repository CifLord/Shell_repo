...
from ocpmodels.models.gemnet_oc.initializers import he_orthogonal_init,get_initializer
from ocpmodels.models.gemnet_oc.layers.atom_update_block import OutputBlock,AtomUpdateBlock #AtomUpdateBlock
from ocpmodels.models.gemnet_oc.layers.base_layers import Dense, ResidualLayer
from ocpmodels.models.gemnet_oc.layers.efficient import BasisEmbedding #EfficientInteractionDownProjection
...
from ocpmodels.models.gemnet_oc.layers.interaction_block import InteractionBlock #InteractionBlockTripletsOnly
...
from scaling import AutomaticFit, ScalingFactor

@registry.register_model("gemnetoc_former")
class GemNetT_TAAG(torch.nn.Module):
    """
    GemNet-OC, Interaction block
...
class OutputBlock(AtomUpdateBlock):
    ...
    def forward(self, h, m, basis_rad, idx_atom):
        ...
        if self.direct_forces:
            ...
            rbf_emb_F = self.dense_rbf_F(basis_rad)  # (nEdges, emb_size_edge)
